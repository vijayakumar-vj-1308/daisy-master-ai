...
assert(gs.state.missionTimeRemaining === 1800, `Default timer is 1800s / 30:00 (got ${gs.state.missionTimeRemaining})`);
...
assert(gs2.state.missionTimeRemaining === 1800, `Reloading intro resets timer to 1800s (got ${gs2.state.missionTimeRemaining})`);
...
assert(gs2.state.missionTimeRemaining === 1800, "Timer remains active 1800s");
